...
from sams_vae.data import VeltenDataModule
...
def get_data_module(config: Dict) -> PerturbationDataModule:
    ...
    data_module = VeltenDataModule(batch_size=256, data_path=adata)
    return data_module
...
if __name__ == "__main__":
    datapath = "/data/a330d/datasets/aml/mutaseq2_3k.h5ad"
    ...
    module = VeltenDataModule(batch_size=256, data_path=adata)

    # Model stuff
    args = Args()
    args.config = '../demo/sams_vae_velten.yaml'
